...
class PIcon:
    ...
    """
    def __init__(self, iconPath: Optional[str] = "") -> None:
    ...
    def LoadImageSDL2(self) -> Any:
        ...
        """
        import sdl2
        return sdl2.SDL_LoadBMP(self.BiconPath)
    ...
    def SetIconSDL2(self, window:Any) -> None:
        ...
        if self.BiconPath:
            sdl2.SDL_SetWindowIcon(window, self.LoadImageSDL2())
        else:
            return None
    ...
    def Free(self) -> None:
        ...
        """
        import sdl2
        if self.LoadImageSDL2():
            sdl2.SDL_FreeSurface(self.LoadImageSDL2())
