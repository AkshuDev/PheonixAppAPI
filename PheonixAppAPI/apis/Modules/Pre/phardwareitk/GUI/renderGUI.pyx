...
if sys.path[PHardwareITK] != None:
    sys.path.append(PHardwareITK_P)

from phardwareitk.Extensions import Color

from math import *

# Utility function to set a color
def SetColor(object color=Color(), float alpha=1.0):
    """
...
def SetBackgroundColor(object color=Color(), float alpha=1.0):
    """
...
def DrawRectangle(float x, float y, float width, float height, object color=Color(), float alpha=1.0):
    """
...
def DrawLine(float x1, float y1, float x2, float y2, object color=Color(), float alpha=1.0):
    """
...
def DrawCircle(float x, float y, float radius, int segments=36, object color=Color(), float alpha=1.0):
    """
...
def DrawText(float x, float y, str text, object color=Color()):
    """
