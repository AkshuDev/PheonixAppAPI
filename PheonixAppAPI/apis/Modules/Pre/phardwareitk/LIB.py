...
class Paths:
    ...
    Extentions = os.path.join(phardwareitk, 'Extentions')
    ...
    __init__PY_Extentions = os.path.join(Extentions, '__init__.py')
    ...
    #Files in Extention
    HyperOutPY_Extentions = os.path.join(Extentions, 'HyperOut.py')
    HyperInPY_Extentions = os.path.join(Extentions, 'HyperIn.py')
    ...
    windows_guiPY_GUI = os.path.join(GUI, 'windows_gui.py')
