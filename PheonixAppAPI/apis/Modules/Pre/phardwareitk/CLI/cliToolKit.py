...
from phardwareitk.Extentions import HyperIn, HyperOut
from phardwareitk import Extentions
...
class Text:
    @staticmethod
    def WriteText(*values:object, seperator:Union[str, None]=" ", endl:Union[str, None]="", File:Union[str, None]=None, Flush:bool=False, backgroundColorEnabled:bool=False, FontEnabled:bool=False, Font:Extentions.TextFont=Extentions.TextFont()) -> None:
        """Writes the specified text. (USES phardwareitk.Extentions.HyperOut.printH)
        ...
        Args:
            ...
            Font (Extentions.TextFont, optional): The font. Defaults to Extentions.TextFont().
        """
    ...
    def InputText(*values:object, seperator:Union[str, None]=" ", endl:Union[str, None]="\n", backgroundColorEnabled:bool=False, FontEnabled:bool=False, Font:Extentions.TextFont=Extentions.TextFont()) -> str:
        """Returns the entered user data from input. (USES phardwareitk.Extentions.HyperIn.inputH)
